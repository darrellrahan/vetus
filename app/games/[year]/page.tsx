...
function page({ params: { year } }: { params: { year: string } }) {
  ...
  return (
    <>
      <main className="bg-black px-8 py-16 lg:py-8 relative overflow-hidden">
        <Meteor />
        <div className="z-10 relative">
          <h1 className="text-center text-6xl lg:text-9xl text-[#512023]">
            {year}
          </h1>
          <p className="text-center text-white text-[0.75rem] my-12">
            You can flip the card by clicking on it!
          </p>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16 lg:mb-24">
